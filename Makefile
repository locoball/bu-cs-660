...
HOME = /home/c/s/cscie268
LIB = $(HOME)/lib

JAVAC = /nfs/home/l/i/libs1/pub/local/i386/jdk1.6.0_14/bin/javac -J-Xms64m -J-Xmx128m -classpath .:$(LIB)/java-cup-11.jar:$(LIB)/jline.jar:$(LIB)/db.jar
JAVA = /nfs/home/l/i/libs1/pub/local/i386/jdk1.6.0_14/bin/java -Xms64m -Xmx128m -classpath .:$(LIB)/java-cup-11.jar:$(LIB)/jline.jar:$(LIB)/db.jar -Djava.library.path=$(LIB)
